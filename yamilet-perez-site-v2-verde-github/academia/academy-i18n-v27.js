(() => {
  ...
  const it = {
    ...
    'Bienvenido': 'Ti diamo il benvenuto',
    'Te damos la bienvenida': 'Ti diamo il benvenuto',
    ...
    'Preparando administración de alumnas…': 'Preparazione della gestione studenti…',
    'Preparando administración de estudiantes…': 'Preparazione della gestione studenti…',
    ...
    'Vista previa de staff · el progreso solo se registra para alumnos inscritos.': 'Anteprima staff · i progressi vengono registrati solo per studenti con iscrizione attiva.',
    'Vista previa de staff · el progreso solo se registra para estudiantes con inscripción activa.': 'Anteprima staff · i progressi vengono registrati solo per studenti con iscrizione attiva.',
    'Módulo': 'Modulo',
    'Lección': 'Lezione',
